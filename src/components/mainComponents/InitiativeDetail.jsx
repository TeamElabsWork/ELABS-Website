...
const initiativesData = {
  "kiito-app": {
    ...
    image: "https://placehold.co/1200x600/1a1a2e/ffffff?text=KIITO+App+Hero",
  ...
  "leet-verse": {
    ...
    image: "https://placehold.co/1200x600/2a1b3d/ffffff?text=Leet+Verse+Hero",
  ...
  "artico": {
    ...
    image: "https://placehold.co/1200x600/4a154b/ffffff?text=Artico+Hero",
  ...
  "renora": {
    ...
    image: "https://placehold.co/1200x600/113f67/ffffff?text=Renora+Hero",
  ...
  "blade-bit": {
    ...
    image: "https://placehold.co/1200x600/800000/ffffff?text=Blade+Bit+Hero",
  ...
  "code-nexus": {
    ...
    image: "https://placehold.co/1200x600/003300/ffffff?text=Code+Nexus+Hero",
...
const InitiativeDetail = () => {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-[#121212] pt-24 pb-20 overflow-hidden">
      {/* Background elements */}
      ...
      <div className="container mx-auto px-4 sm:px-6 relative z-10">
        ...
        <motion.button 
          ...
          className="flex items-center text-gray-600 dark:text-gray-400 hover:text-orange-500 dark:hover:text-orange-400 transition-colors mb-8 group"
        >
        ...
        <div className="flex flex-col lg:flex-row gap-12 items-center mb-20">
          ...
          >
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <button className="px-8 py-3 rounded-full bg-gray-200 dark:bg-gray-800 text-gray-800 dark:text-white font-semibold flex items-center hover:bg-gray-300 dark:hover:bg-gray-700 transition-colors duration-300">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          ...
          >
            <h3 className="text-3xl font-bold mb-6 text-gray-900 dark:text-white">About the Project</h3>
          ...
          <motion.div 
            ...
            className="space-y-8"
          >
            <div className="bg-gray-50 dark:bg-gray-800/50 rounded-2xl p-8 border border-gray-100 dark:border-gray-800 backdrop-blur-sm">
              <h4 className="text-xl font-bold mb-6 text-gray-900 dark:text-white border-b border-gray-200 dark:border-gray-700 pb-4">Key Features</h4>
            ...
            <div className="bg-gray-50 dark:bg-gray-800/50 rounded-2xl p-8 border border-gray-100 dark:border-gray-800 backdrop-blur-sm flex flex-col items-center text-center">
              <div className="w-16 h-16 rounded-full bg-gradient-to-br from-gray-200 to-gray-300 dark:from-gray-700 dark:to-gray-600 mb-4 flex items-center justify-center">
                <span className="text-2xl font-bold text-gray-500 dark:text-gray-400">Team</span>
              </div>
              <h4 className="text-lg font-bold text-gray-900 dark:text-white mb-1">ELABS Core Team</h4>
              <p className="text-sm text-gray-500 dark:text-gray-400 mb-4">Developed with passion</p>
              <button className="w-full py-2 rounded-lg border border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 font-medium hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors">
                View Contributors
              </button>
            </div>
          </motion.div>
